...
- Platform Lead Large Molecule PBPK, ESQlabs
- Principal Scientist, focus on biologics and project workflows
- Likes log scales and reproducible code
...
2. Launch **Remote Desktop Connection** (Windows: `mstsc.exe` · macOS: *Windows App* · Linux: Remmina / FreeRDP)
3. Connect using the **VM address, username, and password** from the email
...
- 📦 **Training materials** — `https://esqlabs.github.io/PAGE2026-R-WORKSHOP/`
