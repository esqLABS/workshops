...
| 10:30–10:45 | ☕ | Break |
| 10:45–12:15 | 2 | Parameterize · Run · Plot |
| 12:15–13:15 | 🍽 | Lunch |
| 13:15–14:00 | 3 | PK params · Sensitivity · Populations |
| 14:00–15:30 | 4 | `{esqlabsR}` project workflow |
| 15:30–15:45 | ☕ | Break |
| 15:45–16:30 | 5 | Advanced SA · Param ID demo |
| 16:30–17:00 | 🎁 | Wrap-up · final feedback · farewell |
...
- Show-of-hands polls at start + key transitions
- All materials online: `r-training.esqlabs.com` / `github.com/esqLABS/r-packages-training`
...
4. **Structure** a regulatory-grade project with `{esqlabsR}`
...
4. Once logged in, double-click **"Workshop Materials"** desktop shortcut
5. RStudio opens with the `r-packages-training` project pre-loaded
...
::: {.r-fit-text}
**Load a PK-Sim model in R · inspect its structure · save it back.**
:::
...
::: {.center-x .r-fit-text}
**See you at 12:15 sharp** for PK params + sensitivity.
...
5. `saveSensitivityCalculation(analysis, outputDir = "Results/SA_Midazolam")` — persist for re-use
...
| Parallel / batch simulations | `workshops/A8.qmd` |
| Table parameters | `workshops/A11.qmd` |
